...
begin
  ...
  try
    ...
    begin
      ...
      Inc(RecCount);
      if UpperCase(DataRecord[_Warehouse]) = 'PSAPP' then
          DataRecord[1] := '';
      ...
      begin
        ...
        begin
          ...
          if Loc1 <> '' then
            WriteLn(OutFile,Loc1 + OutStr+',,'+ProdCode);    //Include a blank field so that this matches the mtd sales output file

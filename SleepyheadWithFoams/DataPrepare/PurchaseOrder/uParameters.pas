...
begin
  ...
  NewParam(ParamNo,'Style File Name','',False,esEllipsis,ptFile);
  NewParam(ParamNo,'Exclude Order Types','',False,esEllipsis,ptFile);
  NewParam(ParamNo,'Exclude Order Types National','',False,esEllipsis,ptFile);
  NewParam(ParamNo,'Exclude Styles','',False,esEllipsis,ptFile);
  NewParam(ParamNo,'Append To Stock File','',False,esEllipsis,ptFile);
  NewParam(ParamNo,'Supplier To Append','',False,esEllipsis,ptFile);
  NewParam(ParamNo,'Output Transport File Name','',False,esEllipsis,ptFile);
end;

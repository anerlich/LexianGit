...
// 1.5 Remove 1.3 changes (should not be included
// 1.6 Add support for foams
// 1.7 Fix for sputious exception records
// 1.8 Fix bug incorrect detection of sleepmaker records
// 1.9 Change Other consumer selection rules
// 2.0 Add Industrial Consumer
// 2.1 Add processing for kip items
// 2.2 Make sure Kip Master file records get selected in Lookup.txt
// 2.3 remove output to VICSKUTMP
...
var
    ...
    OutStr: String;
    InFile,OutFile, ExceptFile:TextFile;
    ...
    GroupCode,PlnGroup,WHcode,Brand,Owner1:String;
begin
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          if (Loc4 <> '') and (Style<>'') and (AnsiPos('_APP',UpperCase(Trim(DataRecord[_Warehouse]))) >= 1) then

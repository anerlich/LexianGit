...
// 1.2 Change column alignment
// 1.3 Change import 120 weeks
...
var
    ...
    RecCount, WCount,CCount,ECount,CompanyID,IndexNo, ZeroiseFrom:Integer;
    OutStr: String;
...
begin
  ...
  try
    ...
    ZeroiseFrom := 99999;
    if (trim(GetParam('Zeroise From Col')) <> '') then
    begin
      ZeroiseFrom := strToInt(trim(GetParam('Zeroise From Col')));
      if (ZeroiseFrom <= _Sales1) then
      begin
        ZeroiseFrom := 99999;
        Say('Zeroise Parameter invalid : '+GetParam('Zeroise From Col'));
      end;
    end;
      ...
      begin
        ...
        OutStr := '';
          ...
          begin
            ...
            if (cCount >= _Sales1) and (trim(TheData)='') then
            begin
              TheData := '0';
            end
            else if cCount >= ZeroiseFrom then
            begin
              TheData := '0';
            end;
            if cCount = _Sales1 then
            begin

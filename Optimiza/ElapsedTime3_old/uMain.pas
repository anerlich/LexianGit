...
//    ValueListEditor1.Strings.Clear;
    ...
    begin
      ...
      if (not Started) and (Pos('STARTED ON',rStr) > 0) then
      begin
      ...
      if StartEnd then
      begin
        if (Pos('SCHEDULE FINISHED ON',rStr) > 0) then
        begin
          StartTime := GetStartTime(rStr);
      ...
      begin
        nStartPos := 17;  //Pos('ELAPSED TIME',rStr) + 13;
        ...
        aValue := Trim(Copy(rStr,nStartPos,8));

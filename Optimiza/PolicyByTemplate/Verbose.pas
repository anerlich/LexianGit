...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        TempName := ParamStr(0);
        FParamFile := AnsiReplaceStr(UpperCase(TempName),'VERBOSE_PUT.EXE','PolicyByTemplate.dat');
      end;
...
begin
  ...
  begin
    ...
    cbConvertWkly.Checked := UpperCase(vleParameters.Values['Convert to Weekly']) = 'YES';
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          MOQ := -1;
          ORM := -1;
          if (cbConvertWkly.Checked = True) then
          begin
          ...
          begin
            ...
            try
              ...
              frmStatus.Say('.........Start SQL',False);
              for SCount := 0 to dmData.qryAlter.SQL.Count-1 do
                if copy(dmData.qryAlter.SQL.Strings[sCount],1,2) = '--' then
                begin
                  frmStatus.Say(dmData.qryAlter.SQL.Strings[sCount],False);
                end;
              frmStatus.Say('.........End SQL',False);
          ...
          begin
            Inc(ErrCount);
            frmStatus.Say('*** ' + ErrMsg+' - '+edtDescription.Text);
            WriteLn(ExceptFile,ErrMsg+' - '+edtDescription.Text);

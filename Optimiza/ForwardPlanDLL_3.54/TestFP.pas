...
begin
  with FPTestDLLDatamodule do begin
    ...
    FItemParams.ConfirmationHorizon := 11;
...
begin
  ...
  FLocationParams.PercentUnsatisfiedOrdersBackOrdered := trunc(SVPMainDataModuleTemplate.ReadConfigFloat(124));

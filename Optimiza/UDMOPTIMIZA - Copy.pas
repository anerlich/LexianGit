...
begin
  ...
  If SvpReg.OpenKey(cVar, False) = True then
  Begin
...
begin
  ...
  With qryDownloadDate do
  begin
    Active := True;
    Result := FieldByName('TYPEOFDATE').AsString;
    Active := False;
  end;
end;
...
begin
  ...
  With qryCalendarPeriod do
  begin
    Active := False;
    SQL.Clear;
    SQL.Add('select * from Calendar where startdate <= "' + InDate +
      '" and enddate >= "' + InDate + '"');
    Active := True;
...
begin
  ...
  With qryCalendarDate do
  begin
    Active := False;
    SQL.Clear;
    SQL.Add('select * from Calendar where CalendarNo = ' +
      IntToStr(CalendarNo));
    Active := True;
...
function TdmOptimiza.PeriodToUnit(PeriodValue: Real;
  Fcs: ForecastTypeRec): Real;
var
...
begin
  ...
  Else IF Fcs.AllTheSame Then
    Result := Fcs.ForecastArray[0] +
      ((PeriodValue - ProrateFactor) * Fcs.ForecastArray[1])
  Else
  Begin
    Result := Fcs.ForecastArray[0];
...
begin
  ...
  begin
    ...
    If Sts = 'Y' then
    begin
      ForecastArray[0] := Max(qryForecastAndPolicyCO0.Value,
        qryForecastAndPolicyF0.Value) + qryForecastAndPolicyBF0.Value +
        qryForecastAndPolicyGF0.Value;

      ForecastArray[0] :=
        Max(0, ForecastArray[0] - qryForecastAndPolicySALESAMOUNT_0.Value);

      ForecastArray[1] := Max(qryForecastAndPolicyCO1.Value,
        qryForecastAndPolicyF1.Value) + qryForecastAndPolicyBF1.Value +
        qryForecastAndPolicyGF1.Value;
      ForecastArray[2] := Max(qryForecastAndPolicyCO2.Value,
        qryForecastAndPolicyF2.Value) + qryForecastAndPolicyBF2.Value +
        qryForecastAndPolicyGF2.Value;
      ForecastArray[3] := Max(qryForecastAndPolicyCO3.Value,
        qryForecastAndPolicyF3.Value) + qryForecastAndPolicyBF3.Value +
        qryForecastAndPolicyGF3.Value;
      ForecastArray[4] := Max(qryForecastAndPolicyCO4.Value,
        qryForecastAndPolicyF4.Value) + qryForecastAndPolicyBF4.Value +
        qryForecastAndPolicyGF4.Value;
      ForecastArray[5] := Max(qryForecastAndPolicyCO5.Value,
        qryForecastAndPolicyF5.Value) + qryForecastAndPolicyBF5.Value +
        qryForecastAndPolicyGF5.Value;
      ForecastArray[6] := Max(qryForecastAndPolicyCO6.Value,
        qryForecastAndPolicyF6.Value) + qryForecastAndPolicyBF6.Value +
        qryForecastAndPolicyGF6.Value;
      ForecastArray[7] := Max(qryForecastAndPolicyCO7.Value,
        qryForecastAndPolicyF7.Value) + qryForecastAndPolicyBF7.Value +
        qryForecastAndPolicyGF7.Value;
      ForecastArray[8] := Max(qryForecastAndPolicyCO8.Value,
        qryForecastAndPolicyF8.Value) + qryForecastAndPolicyBF8.Value +
        qryForecastAndPolicyGF8.Value;
      ForecastArray[9] := Max(qryForecastAndPolicyCO9.Value,
        qryForecastAndPolicyF9.Value) + qryForecastAndPolicyBF9.Value +
        qryForecastAndPolicyGF9.Value;
      ForecastArray[10] := Max(qryForecastAndPolicyCO10.Value,
        qryForecastAndPolicyF10.Value) + qryForecastAndPolicyBF10.Value +
        qryForecastAndPolicyGF10.Value;
      ForecastArray[11] := Max(qryForecastAndPolicyCO11.Value,
        qryForecastAndPolicyF11.Value) + qryForecastAndPolicyBF11.Value +
    ...
    begin
      ...
      ForecastArray[1] := qryForecastAndPolicyCO1.Value +
        qryForecastAndPolicyBF1.Value + qryForecastAndPolicyGF1.Value;
      ForecastArray[2] := qryForecastAndPolicyCO2.Value +
        qryForecastAndPolicyBF2.Value + qryForecastAndPolicyGF2.Value;
      ForecastArray[3] := qryForecastAndPolicyCO3.Value +
        qryForecastAndPolicyBF3.Value + qryForecastAndPolicyGF3.Value;
      ForecastArray[4] := qryForecastAndPolicyCO4.Value +
        qryForecastAndPolicyBF4.Value + qryForecastAndPolicyGF4.Value;
      ForecastArray[5] := qryForecastAndPolicyCO5.Value +
        qryForecastAndPolicyBF5.Value + qryForecastAndPolicyGF5.Value;
      ForecastArray[6] := qryForecastAndPolicyCO6.Value +
        qryForecastAndPolicyBF6.Value + qryForecastAndPolicyGF6.Value;
      ForecastArray[7] := qryForecastAndPolicyCO7.Value +
        qryForecastAndPolicyBF7.Value + qryForecastAndPolicyGF7.Value;
      ForecastArray[8] := qryForecastAndPolicyCO8.Value +
        qryForecastAndPolicyBF8.Value + qryForecastAndPolicyGF8.Value;
      ForecastArray[9] := qryForecastAndPolicyCO9.Value +
        qryForecastAndPolicyBF9.Value + qryForecastAndPolicyGF9.Value;
      ForecastArray[10] := qryForecastAndPolicyCO10.Value +
        qryForecastAndPolicyBF10.Value + qryForecastAndPolicyGF10.Value;
      ForecastArray[11] := qryForecastAndPolicyCO11.Value +
        qryForecastAndPolicyBF11.Value + qryForecastAndPolicyGF11.Value;
    end;
...
procedure TdmOptimiza.CreateTemplateSQL(TemplateNo, UserNo, LocationNo: Integer;
  var SQL, JoinClause: TStringList);
var
  Line, JoinLine, InOrNotIn, tmpstr: string;
  FirstOne: Boolean;
  Count, WhereCount: Integer;
  Template, TemplateMajorGroups, TemplateMinorGroups1, TemplateMinorGroups2,
    TemplateSuppliers, TemplateRepCats, TemplateUserConditions: TIBSQL;
...
begin
  ...
  Template.SQL.Clear;
  Template.SQL.Add
    ('select TEMPLATENO, USERNO, DESCRIPTION, TEMPLATETYPE, MAJORGROUP, MINORGROUP1,');
  Template.SQL.Add
    ('MINORGROUP2, PARETO_A, PARETO_B, PARETO_C, PARETO_D, PARETO_E, PARETO_F,');
  Template.SQL.Add
    ('PARETO_M, PARETO_X, CRITICALITY_1, CRITICALITY_2, CRITICALITY_3, CRITICALITY_4,');
  Template.SQL.Add
    ('CRITICALITY_5, STOCKED, NONSTOCKED, SUPPLIER, GENERICNONE, GENERICPARENTS, GENERICCHILDREN,');
  Template.SQL.Add
    ('EXCLUDEMAJOR, EXCLUDEMINOR1, EXCLUDEMINOR2, EXCLUDESUPPLIER, REPORTCATEGORIES,EXCLUDEREPORTCATEGORY,');
  Template.SQL.Add
    ('NON_BOM_ITEMS, BOM_ONLY, BOM_FINISHED_GOOD, BOM_RAW_MATERIAL');
  ...
  TemplateRepCats.SQL.Add
    ('select TEMPLATENO, REPORTCATEGORYTYPE, REPORTCATEGORYNO');
  ...
  TemplateUserConditions.SQL.Add
    ('select TEMPLATENO, USERFIELD, FIELDVALUE, CONDITION');
  ...
  try
    ...
    FirstOne := True;
    Count := 0;
    if Template.FieldByName('PARETO_A').AsString = 'Y' then
    begin
    ...
    if Template.FieldByName('PARETO_B').AsString = 'Y' then
    begin
      if not FirstOne then
        Line := Line + ',';
      Line := Line + '''B''';
    ...
    if Template.FieldByName('PARETO_C').AsString = 'Y' then
    begin
      if not FirstOne then
        Line := Line + ',';
      Line := Line + '''C''';
    ...
    if Template.FieldByName('PARETO_D').AsString = 'Y' then
    begin
      if not FirstOne then
        Line := Line + ',';
      Line := Line + '''D''';
    ...
    if Template.FieldByName('PARETO_E').AsString = 'Y' then
    begin
      if not FirstOne then
        Line := Line + ',';
      Line := Line + '''E''';
    ...
    if Template.FieldByName('PARETO_F').AsString = 'Y' then
    begin
      if not FirstOne then
        Line := Line + ',';
      Line := Line + '''F''';
    ...
    if Template.FieldByName('PARETO_M').AsString = 'Y' then
    begin
      if not FirstOne then
        Line := Line + ',';
      Line := Line + '''M''';
    ...
    if Template.FieldByName('PARETO_X').AsString = 'Y' then
    begin
      if not FirstOne then
        Line := Line + ',';
      Line := Line + '''X''';
    ...
    if Template.FieldByName('CRITICALITY_1').AsString = 'Y' then
    begin
      if not FirstOne then
        Line := Line + ',';
      Line := Line + '''1''';
    ...
    if Template.FieldByName('CRITICALITY_2').AsString = 'Y' then
    begin
      if not FirstOne then
        Line := Line + ',';
      Line := Line + '''2''';
    ...
    if Template.FieldByName('CRITICALITY_3').AsString = 'Y' then
    begin
      if not FirstOne then
        Line := Line + ',';
      Line := Line + '''3''';
    ...
    if Template.FieldByName('CRITICALITY_4').AsString = 'Y' then
    begin
      if not FirstOne then
        Line := Line + ',';
      Line := Line + '''4''';
    ...
    if Template.FieldByName('CRITICALITY_5').AsString = 'Y' then
    begin
      if not FirstOne then
        Line := Line + ',';
      Line := Line + '''5''';
    ...
    begin
      ...
      begin
        ...
        if (Template.FieldByName('BOM_FINISHED_GOOD').AsString = 'Y') and
          (Template.FieldByName('BOM_RAW_MATERIAL').AsString = 'N') then
        begin
          Line := Line + ' and (i.BOMFINISHEDGOOD in (''Y''))';
        end
        else if (Template.FieldByName('BOM_FINISHED_GOOD').AsString = 'N') and
          (Template.FieldByName('BOM_RAW_MATERIAL').AsString = 'Y') then
        begin
    ...
    if Template.FieldByName('STOCKED').AsString = 'Y' then
    begin
      if not FirstOne then
        Line := Line + ',';
      Line := Line + '''Y''';
    ...
    if Template.FieldByName('NONSTOCKED').AsString = 'Y' then
    begin
      if not FirstOne then
        Line := Line + ',';
      Line := Line + '''N''';
    ...
    if Template.FieldByName('GENERICNONE').AsString = 'Y' then
    begin
      Line := Line + '''N''';
      FirstOne := False;
      inc(Count);
    end;
    if Template.FieldByName('GENERICPARENTS').AsString = 'Y' then
    begin
      if not FirstOne then
        Line := Line + ',';
      Line := Line + '''P''';
    ...
    if Template.FieldByName('GENERICCHILDREN').AsString = 'Y' then
    begin
      if not FirstOne then
        Line := Line + ',';
      Line := Line + '''C''';
    ...
    if Template.FieldByName('MAJORGROUP').AsString = 'Y' then
    begin
      ...
      while not TemplateMajorGroups.eof do
      begin
        if not FirstOne then
          Line := Line + ',';
    ...
    if Template.FieldByName('MINORGROUP1').AsString = 'Y' then
    begin
      ...
      while not TemplateMinorGroups1.eof do
      begin
        if not FirstOne then
          Line := Line + ',';
    ...
    if Template.FieldByName('MINORGROUP2').AsString = 'Y' then
    begin
      ...
      while not TemplateMinorGroups2.eof do
      begin
        if not FirstOne then
          Line := Line + ',';
    ...
    if Template.FieldByName('SUPPLIER').AsString = 'Y' then
    begin
      ...
      while not TemplateSuppliers.eof do
      begin
        if not FirstOne then
          Line := Line + ',';
    ...
    while not TemplateUserConditions.eof do
    begin
      if not FirstOne then
        Line := Line + ') and ';

      tmpstr := UpperCase(COPY(TemplateUserConditions.FieldByName('USERFIELD')
        .AsString, 5, 2));
      ...
      Line := Line + '(' + TemplateUserConditions.FieldByName('USERFIELD')
        .AsString + TemplateUserConditions.FieldByName('CONDITION').AsString +
        tmpstr + TemplateUserConditions.FieldByName('FIELDVALUE').AsString +
        tmpstr + ')';
      FirstOne := False;
      inc(Count);
    ...
    if Template.FieldByName('REPORTCATEGORIES').AsString = 'Y' then
    begin
      CurrentRepCatType := -1;
      ...
      Count := 0;
      Line := '';
      while not TemplateRepCats.eof do
      begin
        if TemplateRepCats.FieldByName('REPORTCATEGORYTYPE').AsInteger <> CurrentRepCatType
        then
        begin
          if Count <> 0 then
          begin
            ...
            JoinLine := 'join ITEM_REPORTCATEGORY r' +
              IntToStr(CurrentRepCatType) + ' on i.ITEMNO = r' +
              IntToStr(CurrentRepCatType) + '.ITEMNO and r' +
              IntToStr(CurrentRepCatType) + '.REPORTCATEGORYTYPE = ' +
              IntToStr(CurrentRepCatType);
            JoinClause.Add(JoinLine);
          end;
          CurrentRepCatType := TemplateRepCats.FieldByName('REPORTCATEGORYTYPE')
            .AsInteger;
          FirstOne := True;
          Count := 0;
          Line := 'r' + IntToStr(CurrentRepCatType) + '.REPORTCATEGORYNO ' +
            InOrNotIn + ' (';
        end;
        if not FirstOne then
          Line := Line + ','
      ...
      begin
        ...
        JoinLine := 'join ITEM_REPORTCATEGORY r' + IntToStr(CurrentRepCatType) +
          ' on i.ITEMNO = r' + IntToStr(CurrentRepCatType) + '.ITEMNO and r' +
          IntToStr(CurrentRepCatType) + '.REPORTCATEGORYTYPE = ' +
          IntToStr(CurrentRepCatType);
        JoinClause.Add(JoinLine);
      end;
...
function TdmOptimiza.ReadConfigFloat(ConfigNo, LocationNo: Integer): double;
var
  InTrans: Boolean;
...
function TdmOptimiza.ReadConfigInt(ConfigNo, LocationNo: Integer): Integer;
var
  InTrans: Boolean;
...
function TdmOptimiza.ReadConfigLongStr(ConfigNo: Integer): string;
var
  InTrans: Boolean;
begin
...
begin
  ...
  aFileName := aFilePath + Format('%d%s%s ' + aFileName + '.log',
  ...
  begin
    ...
    begin
      ...
      if FCount = 1 then
        aFileName := AnsiReplaceStr(aFileName, '.log',
          IntToStr(FCount) + '.log')
      else
        aFileName := AnsiReplaceStr(aFileName, IntToStr(FCount - 1) + '.log',
          IntToStr(FCount) + '.log');

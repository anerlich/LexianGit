object dmOptimiza: TdmOptimiza
  ...
  object qrySearchSP: TIBQuery
    ...
    SQL.Strings = (
        ...
        'SELECT rdb$procedure_name,rdb$procedure_source FROM RDB$PROCEDUR' +
        'ES where upper(rdb$procedure_source ) like upper('#39'%NSW%'#39') order ' +
        'by rdb$procedure_name;'
      '')
    Left = 144
    Top = 256
  end

...
begin
 with dmMainDLL do begin
    ...
    if (GetItemData.FieldByName('STOCK_BUILDNO').AsInteger > 0) then
    begin
     ...
     FItemParams.BackorderRatio := 100;
...
begin
  with dmMainDLL do begin
    ...
    while not GetPOData.eof do begin
      ...
      NewPO[n].OrderNo := 0;
      NewPO[n].OriginalExpectedArrivalDate := GetPOData.FieldByName('ExpectedArrivalDate').AsDateTime;
      NewPO[n].MovedQty := 0;

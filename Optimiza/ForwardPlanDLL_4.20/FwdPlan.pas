...
const
  ...
  MAX_PO_ARRAY_SIZE = 3500;       //### Lexian Change from 20000 ... causes memory issues
  MAX_CO_ARRAY_SIZE = 7000;       //### Lexian Change from 20000 ... causes memory issues
...
type
  ...
  TFPParams = record                  // A B C D -=- CNo -=- Description
    ...
    SplitStockBuildReceipts: Boolean;  //Split buildQty across rc points in build period
...
function GetDLLVersion : ShortString;  stdcall; external 'FwdPlanDLL510.DLL'; 
...
) : Integer; stdCall; external 'FwdPlanDLL510.DLL';

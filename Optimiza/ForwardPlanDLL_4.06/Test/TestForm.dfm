        ...
        object DBGrid1: TDBGrid
          ...
          Columns = <
            ...
            item
              ...
              Title.Caption = 'Next SS'
              Visible = True
            end
            item
              Expanded = False
              FieldName = 'NEXTRCPOINT'
              Title.Caption = 'Next RC'
              Visible = True
            end
            item
              Expanded = False
              FieldName = 'NEXTRPPOINT'
              Title.Caption = 'Next RP'
              Visible = True
            end
            item
              Expanded = False
              FieldName = 'PREVLTPOINT'
              Title.Caption = 'Prev LT'
              Visible = True
            end
            item
              Expanded = False
              FieldName = 'ORIGRCPOINT'
              Title.Caption = 'Original RC Pooint'
              Visible = True
            end>
        end
      end
      ...
      object DBGridEh1: TDBGridEh
        ...
        Columns = <
          ...
          item
            ...
            Footers = <>
            Title.Caption = 'Expected arrival date'
            Width = 160
          end
          item
            EditButtons = <>
            ...
            Footers = <>
            Title.Caption = 'Ideal arrival date'
            Width = 164
          end
          item
            Checkboxes = True

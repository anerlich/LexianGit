...
procedure TdmMainDLL.SetLocationCode(Value : String);
begin
  FLocationCode := Value;
end;

procedure TdmMainDLL.CreateCalendarStruc;
var
  CalCnt, n  : integer;
  InTrans : boolean;
begin
...
procedure TdmMainDLL.SetLocationNo(Value : integer);
begin
  FLocationNo := Value;
  SetupTradingDays;
end;

procedure TdmMainDLL.SetupTradingDays;
var
  DayCnt  : integer;
  Intrans : boolean;
begin
...
function TdmMainDLL.GetMonthFactor : double;
begin
...
procedure TdmMainDLL.OpenFCQuery;
begin
  sqlFC.Close;
...
procedure TdmMainDLL.OpenBOMQuery;
begin
...
procedure TdmMainDLL.OpenDRPQuery;
begin
...
procedure TdmMainDLL.OpenBOMDataSet;
begin
...
procedure TdmMainDLL.OpenDRPDataSet;
begin
...
procedure TdmMainDLL.OpenCOQuery;
begin
  {$ifdef debug}
  QryStartTime := GetTickCount();
  {$endif}
...
procedure TdmMainDLL.OpenPOQuery;
begin
  {$ifdef debug}
  QryStartTime := GetTickCount();
  {$endif}
...
procedure TdmMainDLL.GetConfigParams;
var
  Intrans : boolean;
begin
  {$ifdef debug}
...
procedure TdmMainDLL.LoadConfigParams;
begin
...
procedure TdmMainDLL.LoadItemParams;
begin
...
procedure TdmMainDLL.SetupBOMFC;
var
  n : integer;
begin
  {$ifdef debug}
...
procedure TdmMainDLL.SetupDRPFC;
var
  n : integer;
begin
  {$ifdef debug}
...
function TdmMainDLL.DoCalc : integer;
var
  NoDays : integer;
...
function TdmMainDLL.DoWICalc : integer;
var
  NoDays : integer;
  CalCreateResult : integer;
  InTrans : Boolean;
...
procedure TdmMainDLL.CreateFCSQL;
var
  FFCSql          : String;
  I               : integer;
begin
...
procedure TdmMainDLL.SVPMainDataModuleTemplateCreate(
  Sender: TObject);
begin
  inherited;
  RunFromRO := False;
...
procedure TdmMainDLL.SVPMainDataModuleTemplateDestroy(
  Sender: TObject);
begin
  FreeCalStruc(FCal);
  FreeFltStruc(FFC);
...
procedure TdmMainDLL.ReloadBOM;
var
  n, Cnt : integer;
...
procedure TdmMainDLL.ReloadDRP;
var
  n, Cnt : integer;
  WeekNo, CalNo : integer;
begin
...
procedure TdmMainDLL.CalculateWeeklyTotals;
var
  Cnt : integer;
  WeekNo : integer;
begin
...
procedure TdmMainDLL.CalculateMonthlyTotals;
var
  Cnt : integer;
  CalNo : integer;
begin
...
procedure TdmMainDLL.ResetFCStruc;
begin
  FreeFltStruc(FFC);
  MakeFltStruc(FFC, FNoPeriodsFC);
end;

procedure TdmMainDLL.ResetBOMStruc;
begin
  FreeDemStruc(FBOM);
  MakeDemStruc(FBOM, MAX_DAYS_ARRAY_SIZE);
end;

procedure TdmMainDLL.ResetDRPStruc;
begin
  FreeDemStruc(FDRP);
  MakeDemStruc(FDRP, MAX_DAYS_ARRAY_SIZE);
end;

procedure TdmMainDLL.ResetPOStruc;
begin
  OverPO := 0;
  FreePOStruc(FPO);
  MakePOStruc(FPO, MAX_PO_ARRAY_SIZE);
...
procedure TdmMainDLL.ResetCOStruc;
begin
  OverCO := 0;
  FreeDemStruc(FCO);
  MakeDemStruc(FCO, MAX_CO_ARRAY_SIZE);
...
procedure TdmMainDLL.ReadFromFile(Filename:string);
...
procedure TdmMainDLL.ForceParams(IgnoreMOQMult: Boolean;
  SystemWeeks: String);
begin
  FIgnoreMOQMult := IgnoreMOQMult;
end;

procedure TdmMainDLL.SetDownloadDateAdjustment;
begin
  FAdjustedDownloadDateStart := False;
  FAdjustedDownloadDateEnd := False;
  qryCalendar.First;
...
function TdmMainDLL.BuildCalendar: Integer;
var
  NoDays:Integer;
begin
...
procedure TdmMainDLL.LoadDemandAndLevel;
begin
  LoadDemand(FFP, FFC, FCO, FBOM, FDRP, FPO, FParams);
...
procedure TdmMainDLL.DataModuleDestroy(Sender: TObject);
begin
  FreeCalStruc(FCal);
  FreeFltStruc(FFC);
  FreeDemStruc(FCO);

...
uses TestDM, dmFwdPlanDLL, ELMessages, ELConstants;
...
begin
  with FwdPlanDLLDataModule do begin
    ...
    edtSSDays.Text := IntToStr(Trunc(dmTest.qryItemSAFETYSTOCK.AsFloat * FNoDaysInPeriod));
    edtRCDays.Text := IntToStr(Trunc(dmTest.qryItemREPLENISHMENTCYCLE.AsFloat * FNoDaysInPeriod));
    edtRPDays.Text := IntToStr(Trunc(dmTest.qryItemREVIEWPERIOD.AsFloat * FNoDaysInPeriod));
    edtLTDays.Text := IntToStr(Trunc(dmTest.qryItemLEADTIME.AsFloat * FNoDaysInPeriod));
    edtTransitLT.Text := IntToStr(Trunc(dmTest.qryItemTRANSITLT.AsFloat * FNoDaysInPeriod));
...
begin
  with FwdPlanDLLDataModule do begin
    ...
    StockOnOrderOther := dmTest.qryItem.FieldByName('STOCKONORDER_OTHER').AsInteger;
    StockOnOrderInLT := dmTest.qryItem.FieldByName('STOCKONORDERINLT').AsInteger;
    StockOnOrderInLTOther := dmTest.qryItem.FieldByName('STOCKONORDERINLT_OTHER').AsInteger;

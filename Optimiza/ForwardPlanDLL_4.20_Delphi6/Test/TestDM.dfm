object dmTest: TdmTest
  ...
  object SVPDatabase: TIBDatabase
    DatabaseName = '10.0.0.102:c:\support\jci\jci-420.gdb'
    Params.Strings = (
      'user_name=SYSDBA'
      'password=masterkey')
    LoginPrompt = False
  ...
  object qryTest: TIBDataSet
    ...
    object qryTestNEXTSSPOINT: TIntegerField
      FieldName = 'NEXTSSPOINT'
      Required = True
    end
    object qryTestNEXTRCPOINT: TIntegerField
      FieldName = 'NEXTRCPOINT'
      Required = True
    end
    object qryTestNEXTRPPOINT: TIntegerField
      FieldName = 'NEXTRPPOINT'
      Required = True
    end
    object qryTestPREVLTPOINT: TIntegerField
      FieldName = 'PREVLTPOINT'
      Required = True
    end
    object qryTestORIGRCPOINT: TIntegerField
      FieldName = 'ORIGRCPOINT'
      Required = True
    end
    object qryTestFACTOR: TFloatField
      FieldName = 'FACTOR'
      Required = True
      DisplayFormat = '#.###'
    end
  ...
  object qryItem: TIBDataSet
    ...
    object qryItemEFFECTIVERC: TFloatField
    ...
    object qryItemMIN_SS_UNITS: TFloatField
      FieldName = 'MIN_SS_UNITS'
      Origin = 'ITEM.MIN_SS_UNITS'
    end
  end

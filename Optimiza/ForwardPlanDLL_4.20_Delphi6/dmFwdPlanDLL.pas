...
SaveDateformat := FormatSettings.ShortDateformat;{$ENDIF}
  {$IFDEF VER140}
   ShortDateFormat := 'dd/mm/yyyy';
{$ELSE}FormatSettings.ShortDateFormat := 'dd/mm/yyyy';{$ENDIF}

{$IFDEF VER140} DateSeparator {$ELSE} FormatSettings.DateSeparator {$ENDIF} := '/';

...
begin
  ...
  SetParam('Schedule File Name',True,esEllipsis);
  SetParam('Scheduler Set File Name',True,esEllipsis);
...
begin
  ...
  begin
    if opendialog1.Execute then
      VleParameters.Values['Scheduler Set File Name'] := opendialog1.FileName;
  end;

  if RowNo = 2 then
  begin
    if opendialog1.Execute then
      VleParameters.Values['Schedule File Name'] := opendialog1.FileName;
  end;

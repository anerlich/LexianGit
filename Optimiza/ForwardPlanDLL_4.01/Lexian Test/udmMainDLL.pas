...
procedure TdmMainDLL.OpenFCQuery(CalendarNo : integer);
begin
//  {$ifdef debug}
...
function TdmMainDLL.MustExcludePOfromSurplus(IndicatorToExclude: String): Boolean;
begin
...
//Never used!!!!!
(*function TdmMainDLL.GetEffRC : integer;
var
i          : integer;
RunningMOQ : double;
begin
...
procedure TdmMainDLL.CreateStructures;
begin
...
procedure TdmMainDLL.FreeStructures;
begin
  FreeCalStruc(FCal);
  FreeFltStruc(FFC);
  FreeDemStruc(FCO);
...
//              FParams.PeriodsOnHand:10, //  ClosingStockPeriods:10:2,
    ...
    if NeedMessage then
    {$ifndef DataOnly}
      Showmessage(msg_FwdPlanFileSaved + #13#10 + filename + #13#10 +
                  msg_FwdPlanFileSend1 + SupportEmail +
                  msg_FwdPlanFileSend2);
    {$endif}
  finally
...
begin
  ...
  {$ifndef DataOnly}
    Showmessage(msg_FwdPlanFileNotFound + #13#10 + filename);
  {$endif}
    exit
  end;

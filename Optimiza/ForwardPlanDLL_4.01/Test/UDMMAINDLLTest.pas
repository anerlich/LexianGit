...
uses
  Windows, Messages, SysUtils, Classes, Graphics, Controls, Forms, Dialogs,
   Db, IBSQL, IBCustomDataSet, IBDatabase, FwdPlan, UDMOPTIMIZA,
  IBStoredProc, IBQuery;

type
  TdmMainDLLTest = class(TdmOptimiza)
    ...
    qryCalendarPERIOD2: TIntegerField;
    GetItemData1: TIBDataSet;
    GetItemData1ITEMNO: TIntegerField;
    GetItemData1LOCATIONCODE: TIBStringField;
    GetItemData1LDESCRIPTION: TIBStringField;
    GetItemData1PRODUCTCODE: TIBStringField;
    GetItemData1PDESCRIPTION: TIBStringField;
    GetItemData1STOCKINGINDICATOR: TIBStringField;
    GetItemData1PARETOCATEGORY: TIBStringField;
    GetItemData1SAFETYSTOCK: TFloatField;
    GetItemData1LEADTIME: TFloatField;
    GetItemData1REPLENISHMENTCYCLE: TFloatField;
    GetItemData1REVIEWPERIOD: TFloatField;
    GetItemData1STOCKONHAND: TFloatField;
    GetItemData1BACKORDER: TFloatField;
    GetItemData1MINIMUMORDERQUANTITY: TFloatField;
    GetItemData1ORDERMULTIPLES: TFloatField;
    GetItemData1CONSOLIDATEDBRANCHORDERS: TFloatField;
    GetItemData1BINLEVEL: TFloatField;
    GetItemData1SALESAMOUNT_0: TFloatField;
    GetItemData1FORWARD_SS: TFloatField;
    GetItemData1FORWARD_SSRC: TFloatField;
    GetItemData1RECOMMENDEDORDER: TFloatField;
    GetItemData1TOPUPORDER: TFloatField;
    GetItemData1IDEALORDER: TFloatField;
    GetItemData1LOCATIONNO: TIntegerField;
    GetItemData1ABSOLUTEMINIMUMQUANTITY: TFloatField;
    GetItemData1CALC_IDEAL_ARRIVAL_DATE: TIBStringField;
    GetItemData1TRANSITLT: TFloatField;
    GetItemData1STOCKONORDER: TFloatField;
    GetItemData1STOCKONORDERINLT: TFloatField;
    GetItemData1BACKORDERRATIO: TIntegerField;
    GetItemData1BOMBACKORDERRATIO: TIntegerField;
    GetItemData1DRPBACKORDERRATIO: TIntegerField;
    GetItemData1STOCK_BUILDNO: TIntegerField;
    GetItemData1STOCKONORDER_OTHER: TFloatField;
    GetItemData1STOCKONORDERINLT_OTHER: TFloatField;
    GetItemData: TIBSQL;
    Calendar: TIBSQL;
    function GetMonthFactor : double;
    procedure OpenFCQuery;
...
//    function GetEffRC : integer;
  public
    ...
    procedure ForceParams(IgnoreMOQMult:Boolean;SystemWeeks:String);
    procedure SetDownloadDateAdjustment;
    function BuildCalendar:Integer;
    procedure LoadDemandAndLevel;
  end;

var
  dmMainDLLTest: TdmMainDLLTest;
...
procedure TdmMainDLLTest.SetLocationCode(Value : String);
begin
  FLocationCode := Value;
end;

procedure TdmMainDLLTest.SetLocationNo(Value : integer);
begin
end;

function TdmMainDLLTest.GetMonthFactor : double;
begin
...
procedure TdmMainDLLTest.OpenFCQuery;
begin
  sqlFC.Close;
  sqlFC.ParamByName('ITEMNO').AsInteger := ItemNo;
  sqlFC.ParamByName('CALENDARNO').AsInteger := FCurrentPeriod;
...
procedure TdmMainDLLTest.OpenBOMQuery;
begin
...
procedure TdmMainDLLTest.OpenDRPQuery;
begin
...
procedure TdmMainDLLTest.OpenBOMDataSet;
begin
...
procedure TdmMainDLLTest.OpenDRPDataSet;
begin
...
procedure TdmMainDLLTest.OpenCOQuery;
begin
  {$ifdef debug}
  QryStartTime := GetTickCount();
  {$endif}
...
procedure TdmMainDLLTest.OpenPOQuery;
begin
  {$ifdef debug}
  QryStartTime := GetTickCount();
  {$endif}
...
procedure TdmMainDLLTest.GetConfigParams;
var
  Intrans : boolean;
begin
  {$ifdef debug}
...
procedure TdmMainDLLTest.LoadConfigParams;
begin
...
procedure TdmMainDLLTest.LoadItemParams;
begin
...
procedure TdmMainDLLTest.SetupFC;
var
  n : integer;
begin
  {$ifdef debug}
...
procedure TdmMainDLLTest.SetupBOMFC;
var
  n : integer;
begin
  {$ifdef debug}
...
procedure TdmMainDLLTest.SetupDRPFC;
var
  n : integer;
begin
  {$ifdef debug}
...
procedure TdmMainDLLTest.SetupCO;
var
  LDate : TDateTime;
begin
  {$ifdef debug}
...
procedure TdmMainDLLTest.SetupPO;
begin
  {$ifdef debug}
  QryStartTime := GetTickCount();
  {$endif}
...
function TdmMainDLLTest.DoCalc : integer;
var
  NoDays : integer;
...
function TdmMainDLLTest.DoWICalc : integer;
var
  NoDays : integer;
  CalCreateResult : integer;
  InTrans : Boolean;
...
procedure TdmMainDLLTest.LoadFCWI;
var
  InTrans : Boolean;
begin
  FromFC := False;
...
procedure TdmMainDLLTest.CreateFCSQL;
var
  FFCSql          : String;
  I               : integer;
begin
...
procedure TdmMainDLLTest.SVPMainDataModuleTemplateCreate(
  Sender: TObject);
begin
  inherited;
  RunFromRO := False;
...
procedure TdmMainDLLTest.SVPMainDataModuleTemplateDestroy(
  Sender: TObject);
begin
  FreeCalStruc(FCal);
  FreeFltStruc(FFC);
...
procedure TdmMainDLLTest.ReloadBOM;
var
  n, Cnt : integer;
...
procedure TdmMainDLLTest.ReloadDRP;
var
  n, Cnt : integer;
  WeekNo, CalNo : integer;
begin
...
procedure TdmMainDLLTest.ReloadPO;
var
  n, Cnt : integer;
  WeekNo, CalNo : integer;
begin
...
procedure TdmMainDLLTest.CalculateWeeklyTotals;
var
  Cnt : integer;
  WeekNo : integer;
begin
...
procedure TdmMainDLLTest.CalculateMonthlyTotals;
var
  Cnt : integer;
  CalNo : integer;
begin
...
procedure TdmMainDLLTest.ResetFCStruc;
begin
  FreeFltStruc(FFC);
  MakeFltStruc(FFC, FNoPeriodsFC);
end;

procedure TdmMainDLLTest.ResetBOMStruc;
begin
  FreeDemStruc(FBOM);
  MakeDemStruc(FBOM, MAX_DAYS_ARRAY_SIZE);
end;

procedure TdmMainDLLTest.ResetDRPStruc;
begin
  FreeDemStruc(FDRP);
  MakeDemStruc(FDRP, MAX_DAYS_ARRAY_SIZE);
end;

procedure TdmMainDLLTest.ResetPOStruc;
begin
  OverPO := 0;
  FreePOStruc(FPO);
  MakePOStruc(FPO, MAX_PO_ARRAY_SIZE);
...
procedure TdmMainDLLTest.ResetCOStruc;
begin
  OverCO := 0;
  FreeDemStruc(FCO);
  MakeDemStruc(FCO, MAX_CO_ARRAY_SIZE);
...
procedure TdmMainDLLTest.SaveResultsToFile(Filename:String);
...
procedure TdmMainDLLTest.SaveToFile(Filename:string);
...
procedure TdmMainDLLTest.ReadFromFile(Filename:string);
...
procedure TdmMainDLLTest.ForceParams(IgnoreMOQMult: Boolean;
  SystemWeeks: String);
begin
  FIgnoreMOQMult := IgnoreMOQMult;
end;

procedure TdmMainDLLTest.SetDownloadDateAdjustment;
begin
  FAdjustedDownloadDateStart := False;
  FAdjustedDownloadDateEnd := False;
  qryCalendar.First;
...
function TdmMainDLLTest.BuildCalendar: Integer;
var
  NoDays:Integer;
begin
...
procedure TdmMainDLLTest.LoadDemandAndLevel;
begin
  LoadDemand(FFP, FFC, FCO, FBOM, FDRP, FPO, FParams);

...
type
  ...
  public
    ...
    g_sForceDailyReviewPeriod : String;
...
begin
  ...
  FNoPeriodsToFC := dmMainDLL.GetConfigAsInteger(101);
  FLocationParams.NoPeriodsForecast := FNoPeriodsToFC;
  FLocationParams.MaxForwardCover := trunc(dmMainDLL.GetConfigAsFloat(264));
  ...
  FLocationParams.PercentUnsatisfiedOrdersBackOrdered := trunc(dmMainDLL.GetConfigAsFloat(124));
...
begin
 with dmMainDLL do begin
    ...
    FItemParams.ConfirmationHorizon := 24;
